...
const plans = [
  {
    ...
    features: [
      ...
      'Positionnement & recommandations pricing',
  ...
  },
  {
    ...
    features: [
      '5-10 concurrents (profils détaillés)',
      'Positionnement + taglines + messaging',
      'Analyse pricing concurrentielle',
      'Customer insights & white spaces',
      'Plan d\'action avec quick wins',
  ...
  },
  {
    ...
    features: [
      ...
      'Agency-grade (PESTEL, Porter, SWOT)',
      'Stratégie complète brand & pricing',
      'Modèle économique + unit economics',
      'Roadmap 12 mois phasée avec KPIs',
